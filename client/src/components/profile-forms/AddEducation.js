...
const AddEducation = ({addEducation, history}) => {
    ...
    return (
      ...
      <form className="form" onSubmit={e=>{e.preventDefault(); addEducation(formData, history)}}>
        ...
        <div className="form-group">
          <input type="text" placeholder="Major" name="major" value = {major} onChange={e=>onChange(e)}/>
        </div>
        <div className="form-group">
          <h4>From Date</h4>
        ...
        <Link className="btn btn-primary my-1" to="/dashboard"><FontAwesomeIcon icon = {faArrowAltCircleLeft}/> Go Back</Link>
      </form>
        </Fragment>
    )
}
